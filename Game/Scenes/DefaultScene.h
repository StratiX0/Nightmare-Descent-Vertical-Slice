...
public:
	DefaultScene() : Scene("DefaultScene")
	{
		...
		CreateInGameObject("Ground", "Object", Maths::Vector2f(0.0f, 0.0f), Maths::Vector2f(100.f, 900.0f), 1.0f, sf::Color::Transparent);
		...
		CreateInGameObject("Platform", "Object", Maths::Vector2f(300.f, 675.0f), Maths::Vector2f(300.f, 25.0f), 1.0f, sf::Color::Green);
	}
};
